...
open class NetworkSocketDelegate: NSObject,GCDAsyncSocketDelegate {
    ...
    **/
    var newSocketQueueForConnectionHandler: ((_ address: Data, _ sock: GCDAsyncSocket) -> NSObject?)?
    ...
    **/
    var socketDidAcceptNewSocketHandler: ((_ sock: GCDAsyncSocket, _ newSocket: GCDAsyncSocket) -> Void)?

    
    /// Called when a socket connects and is ready for reading and writing.
    var socketDidConnectToHostHandler: ((_ sock: GCDAsyncSocket, _ host: String, _ port: UInt16) -> Void)?

    /**
     * Called when a socket connects and is ready for reading and writing.
     * The host parameter will be an IP address, not a DNS name.
     **/
    var socketDidConnectToURLHandler: ((_ sock: GCDAsyncSocket, _ url: URL) -> Void)?

    /**
     * Called when a socket has completed reading the requested data into memory.
     * Not called if there is an error.
    **/
    var socketDidReadDataWithTagHandler: ((_ sock: GCDAsyncSocket, _ data: Data, _ tag: Int) -> Void)?
    ...
    **/
    var socketDidReadPartialDataOfLengthHandler: ((_ sock: GCDAsyncSocket,
                                                   _ partialLength: UInt,
                                                   _ tag: Int) -> Void)?

    /// Called when a socket has completed writing the requested data. Not called if there is an error.
    var socketDidWriteDataWithTagHandler: ((_ sock: GCDAsyncSocket, _ tag: Int) -> Void)?

    /**
     * Called when a socket has written some data, but has not yet completed the entire write.
     * It may be used to for things such as updating progress bars.
    **/
    var socketDidWritePartialDataOfLengthHandler: ((_ sock: GCDAsyncSocket,
                                                    _ partialLength: UInt,
                                                    _ tag: Int) -> Void)?
    ...
    **/
    var socketShouldTimeoutReadWithTagHandler: ((_ sock: GCDAsyncSocket,
                                                 _ tag: Int,
    ...
    **/
    var socketShouldTimeoutWriteWithTagHandler: ((_ sock: GCDAsyncSocket,
                                                  _ tag: Int,
                                                  _ elapsed: TimeInterval,
                                                  _ length: UInt) -> TimeInterval)?
    ...
    **/
    var socketDidCloseReadStreamHandler: ((_ sock: GCDAsyncSocket) -> Void)?
    ...
    **/
    var socketDidDisconnectWithErrorHandler: ((_ sock: GCDAsyncSocket, _ err: Error?) -> Void)?
    ...
    **/
    var socketDidSecureHandler: ((_ sock: GCDAsyncSocket) -> Void)?
    ...
    **/
    var socketDidReceiveTrustHandler: ((_ sock: GCDAsyncSocket,
                                        _ trust: SecTrust,
